...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train UNet baseline on preprocessed BTXRD.")
...
def build_dataset(split_cfg: dict[str, Any], train_cfg: dict[str, Any], split_name: str, max_samples: int | None) -> BTXRDSegmentationDataset:
